...
function selectData($acode){
    ...
    $sql = "select a.prov_code, a.prov_nam_t, count(b.acq_date) as hp_count
            from ud_province_4326 a 
            LEFT JOIN hotspot_ud_today b ON a.prov_code=b.prov_code
            group by a.prov_code, a.prov_nam_t";
